...
/* Modify to ES2 mudlib base by Annehiltor@ES2
 * Ported to Mud SJ by jpei@SJ
 * [98-6-11] Because the SJ mudlib upgrade to under MudOS v22pre11
 *           the 'nosave' value modify to 'nosave'
 *           the 'nosave' function modify to 'protected'
 *           add inherit F_DBASE by jpei@SJ for system channel message.
 */
...
#define DEFAULT_HEADER "Server: "+"SJ"+"/0.2\nMIME-version: 1.0%c"
...
void remove()
{
	CHANNEL_D->do_channel(this_object(), "sys", "ＷＥＢ服务已经终止。");
	socket_close(httpSock);
}
