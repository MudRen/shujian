...
#define SKILLS_LEVEL            280
#define KNOWLEDGE_LEVEL 200
#define GIVE_EXP                2500000
#define MAX_NEILI               7000
...
void create()
{
    set_name(HIW"书剑礼物使者"NOR, ({ "shizhe" }));
...
ob->delete_skill(skl[i]);              
   ...
   message_vision(HIW"另外赠送你一个月的贵宾服务时间！\n"NOR,me,ob);    
...
//    ob->set("per",10+random(20))
    ...
    ob->add("vip/vip_time",30*24*3600);
    ob->set("SJ_Credit",2000);
