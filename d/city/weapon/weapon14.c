...
([ /* sizeof() == 28 */
  ...
  "wield_msg" : "[1;32m
$N½«ÊÖÔÚ·çÖĞÒ»»Ó£¬ÎŞÊıµÄ»ğĞÇ´ÓËÄ·½·ÉÀ´£¬½¥½¥¾ÛÔÚÒ»Æğ¡«¡«¡«Ò»±ú$n[1;32mÒÑ¾­³öÏÖÔÚ$PÊÖÖĞ£¡
[0;0m",
  "b_id" : "jian",
  ...
  "skill_type" : "sword",
  "unwield_msg" : "[1;32m
$N½«$n[1;32mËæÊÖÒ»ÈÓ£¬Ö»¼û$n[1;32mÍ»È»±äµÃ»ğºì£¬»¯×öÎŞÊıµÄ»ğĞÇËÄÉ¢Æ®×ßÁË£¡
[0;0m",
  "flag" : 4,
  "no_sell" : 1,
  "name" : "[0;31mÁúÈª½£[0;0m",
  ...
  "long2" : "[0;31mÁúÈª±¦½££¬ÈË¼ä¼«Æ·£¬ÎäÁÖÖÁ±¦£¡
[0;0m",
  "basic_name" : "[0;31mÁúÈª",
  "wield_str" : 41,
])
);
