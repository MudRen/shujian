...
([ /* sizeof() == 25 */
  "weight" : 20663,
  "wield_msg" : "[1;37m
$N½«ÊÖÒ»»Ó£¬Ò»±ú$n[1;37m´ÓÉíºó·É³ö£¬µç¹âÒ»ÉÁ£¬ÒÑ¾­ÎÕÔÚÁË$PÊÖÖĞ¡£
[0;0m",
  "b_id" : "chui",
  "value" : 2007360,
  "long" : "",
  ...
  "sharpness" : 3,
  "weapon_prop/damage" : 102,
  "rigidity" : 3,
  "hammer_count" : 5,
  "name_st" : ({ }),
  "skill_type" : "hammer",
  "unwield_msg" : "[1;37m
$N½«ÊÖÖĞµÄ$n[1;37mÒ»µ¯£¬µç¹âÉÁÒ«ÖĞ£¬ÒÑ²»¼ûÁË$n[1;37mµÄ×Ù¼£¡£
[0;0m",
  "flag" : 1,
  "name" : "[1;36mÌìµØ´¸[0;0m",
  "no_sell" : 1,
  ...
  "unit" : "±ú",
  "wield_neili" : 1444,
  "long2" : "[1;36mÌìµØÖ®³õ£¬Å®æ´²¹ÌìËùÁôÏÂµÄÌìµØ¼äÖÁ×ğÖ®ÎïÖ®Ò»¾­Ç§ÇïÍòÔØËùÖÆ£¬¹¦ÄÜ¿ªÌìÅüµØ£¡
[0;0m",
  "basic_name" : "[1;36mÌìµØ",
  "wield_str" : 40,
])
);
