...
if ( !me->query_temp("互动任务/襄阳大战/阵营") || me->query_temp("互动任务/襄阳大战/阵营") != 2)
return notify_fail("你不能指挥冲车。\n");
...
if(random(10)>6)
{
message_vision(YEL"突然从城楼上落下几个滚木雷石，正砸中"+cart->query("name")+YEL"，一时不能动弹。\n"NOR, me);
...
message_vision(YEL""+this_object()->query("name")+YEL"也随着一声巨响散架了。\n"NOR, me);
destruct(obj);
