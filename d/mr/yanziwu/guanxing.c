...
LONG
	...
	if (arg == "sky") {
		...
		me->improve_skill("douzhuan-xingyi", me->query_int());

		write("你又掌握了一些在实战中运用斗转星移的技巧。\n");
if( me->query("quest/bishen/pass")){
me->set_skill("douzhuan-xingyi",me->query_skill("shenyuan-gong",1));
           write("你已经了悟姑苏慕容以彼之道还施彼身的真谛，略一凝神，当即明悟。\n");
           write(HIW"你的"HIC"「斗转星移」"HIW"提升到了你目前所能掌握的最高等级。\n"NOR);
}
