...
void create()
{
	set_name(CYN"『航海布阵方略』"NOR, ({ "sailing's book", "book" }));
	set_weight(500);
	if( clonep() )
		set_default_object(__FILE__);
	else {
		set("unit", "本");
		set("long", HIY"这是一本施琅将军手书的航海布阵方略，\n"+
			"你觉得自己应该仔细研读（Read）一下。\n"NOR);
		set("value", 1);
		set("material", "paper");
                            set("treasure", 1);
...
int do_du(string arg)
{
	...
	i = (int)me->query_skill("sailing", 1);
	...
	me->improve_skill("sailing", me->query_int() + 30);
	write("你仔细研读着"+ob->name()+"，觉得自己海战行军布阵之术受益良多。\n");
	return 1;
}
