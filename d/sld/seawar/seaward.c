...
void flee(object me,int idx,int team)
{
	...
	utime = time() - sea[idx]["starttime"];
        ...
        else if(utime<660) exp = g * 36*4/7;
        else if(utime<720) exp = g * 38*4/8;
        else if(utime<780) exp = g * 41*4/8;
        else if(utime<900) exp = g * 45*4/8;
        else if(utime<1020) exp = g * 46*4/8; 
        else if(utime<1200) exp = g * 48*4/8;
        else if(utime<1500) exp = g * 51*4/8;
        else exp = g * 53*3/8;
