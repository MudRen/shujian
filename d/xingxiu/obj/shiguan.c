...
int start_liandu(object me)
{
        ...
        case 11:
                ...
                me->improve_skill("force", me->query_con()*2);
                break;
        case 21:
...
上角，以屈下颊至；又从耳後入耳中，出走耳前，交颊。三路合于一处！\n"NOR);
                ...
                me->improve_skill("force", me->query_dex()*2);
                break;
        case 51:
      ...
      TASKREWARD_D->get_reward(me,"星宿炼毒",-1,0,0,4+random(3),0,0,0,0);
