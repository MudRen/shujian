...
void create()
{
	set_name(HIR"洪荒·神圣勇者护腕"NOR, ({"yongzhe huwan"}) );
	set_weight(400);
	if(clonep())
...
if( me->query("jinglian/yongzhe huwan"))
{
j = me->query("jinglian/yongzhe huwan");

set("armor_prop/armor", j*30);
             set("armor_prop/parry", j*30);
            //  set("armor_prop/dodge", j*30);
            //  set("armor_prop/dexerity",j*2);
            //  set("armor_prop/strength",j*3);
            //  set("armor_prop/intelligence",j*2);
